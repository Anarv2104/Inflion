...
All notable changes to Inflion will be documented in this file.
...
### Changed
- Refined README migration note after rebrand from TraceIQ to Inflion.
- Replaced download badge source from PePy to Shields.io.
- Improved package page presentation and badge consistency.

## [0.1.4] - 2026-04-08

### Changed
- Cleaned README migration note after rebrand from TraceIQ to Inflion.
- Refined package page and badge presentation.
...
### Changed
- Renamed package from `traceiq` to `inflion`. No functional changes; reset version to `0.1.0` for the new identity.
